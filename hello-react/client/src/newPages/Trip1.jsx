            ...
            <div className='tripMain'>
                <div className='menuMain'>
                    ...
                    <div className='menuMainInfo'>
                        ...
                        <div id='hrefOverview' className='menuMainInfoItemShaded'>
                            <h1 className='menuMainInfoTitle'>Overview</h1>
                        </div>
                        <div id='hrefRestaurants' className='menuMainInfoItem'>
                        ...
                        <div id='hrefActivities' className='menuMainInfoItem'>
                            <MenuMainOverviewItem
                                title="Activities"
                            >
                                <ItemHolder
                        ...
                        <div id='hrefAccomodations' className='menuMainInfoItem'>
                            <MenuMainOverviewItem
                                title="Accomodations"
                            >
                                <ItemHolder
                                    image={naplesHouse}
                                    line1='Naples Paradise Stay'
                                    line2='Beach District'
                                    line3='$309'
                                >
                                </ItemHolder>
                        ...
                        <div id='hrefItinerary' className='menuMainInfoItemShaded'>
                            <h1 className='menuMainInfoTitle'>Itinerary</h1>
                        </div>
                        <div id='hrefDay1' className='menuMainInfoItem'>
                            <MenuMainOverviewItem
                                title="Day 1"
                            >
                                <ItemHolder
                        ...
                        <div id='hrefDay2' className='menuMainInfoItem'>
                            <MenuMainOverviewItem
                                title="Day 2"
                            >
                                <ItemHolder
                        ...
                        <div id='hrefDay3' className='menuMainInfoItem'>
                            <MenuMainOverviewItem
                                title="Day 3"
                            >
                                <ItemHolder
                        ...
                        <div id='hrefBudget' className='menuMainInfoItemShaded'>
                            <h1 className='menuMainInfoTitle'>Budget</h1>
                        </div>
                        <div id='hrefBreakdown' className='menuMainInfoItem'>
                            <MenuMainOverviewItem
                                title="Breakdown"
                            >
                            </MenuMainOverviewItem>
